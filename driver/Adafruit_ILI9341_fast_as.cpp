...
ICACHE_FLASH_ATTR void Adafruit_ILI9341::transmitCmdData(uint8_t cmd, const uint8_t *data, uint8_t numDataByte)
{
	hspi_wait_ready();
	TFT_DC_COMMAND;
	hspi_send_uint8(cmd);
...
ICACHE_FLASH_ATTR void Adafruit_ILI9341::drawPixel(int16_t x, int16_t y, uint16_t color) {
...
ICACHE_FLASH_ATTR void Adafruit_ILI9341::drawFastVLine(int16_t x, int16_t y, int16_t h,
		uint16_t color) {
...
ICACHE_FLASH_ATTR void Adafruit_ILI9341::drawFastHLine(int16_t x, int16_t y, int16_t w,
		uint16_t color) {
...
// fill a rectangle
ICACHE_FLASH_ATTR void Adafruit_ILI9341::fillRect(int16_t x, int16_t y, int16_t w, int16_t h,
		uint16_t color) {
...
ICACHE_FLASH_ATTR uint16_t Adafruit_ILI9341::color565(uint8_t r, uint8_t g, uint8_t b) {
...
ICACHE_FLASH_ATTR void Adafruit_ILI9341::setRotation(uint8_t m) {
...
ICACHE_FLASH_ATTR void Adafruit_ILI9341::invertDisplay(bool i) {
