...
ICACHE_FLASH_ATTR void hspi_init(void)
{
...
ICACHE_FLASH_ATTR void hspi_send_uint16_r(uint16_t data, int32_t repeats)
{
	uint32_t i;
...
ICACHE_FLASH_ATTR void hspi_send_data(const uint8_t * data, uint8_t datasize)
{
