...
LIBS = c gcc hal phy pp net80211 lwip wpa main crypto mirom
#mirom - math lib, copy from ESP8266_RTOS_SDK\lib\libmirom.a 
...
#CXXFLAGS = -O2 -Wpointer-arith -Wundef -Werror -Wl,-EL -nostdlib -mlongcalls -mtext-section-literals -mno-serialize-volatile -D__ets__ -DICACHE_FLASH -fno-rtti -fno-exceptions
...
#LD_SCRIPT = eagle.flash.4m.ld #from arduino sdk 
